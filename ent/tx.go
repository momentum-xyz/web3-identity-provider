...
func (tx *Tx) init() {
	tx.Web3Challenge = NewWeb3ChallengeClient(tx.config)
	tx.Web3User = NewWeb3UserClient(tx.config)
}
...
// applies a query, for example: Web3Challenge.QueryXXX(), the query will be executed
